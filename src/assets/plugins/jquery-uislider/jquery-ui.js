...
$.extend(Datepicker.prototype, {
	...
	_connectDatepicker: function(target, inst) {
		...
		input.addClass(this.markerclass).keydown(this._doKeyDown).
		...
		if(!o.placeholder || o.placeholder.constructor === String) {
			...
			o.placeholder = {
				element: function() {
					...
					var nodeName = that.currentItem[0].nodeName.toLowerCase(),
						element = $( "<" + nodeName + ">", that.document[0] )
							.addClass(class || that.currentItem[0].class+" ui-sortable-placeholder")
				...
				update: function(container, p) {
					...
					// 1. If a class is set as 'placeholder option, we don't force sizes - the class is responsible for that
