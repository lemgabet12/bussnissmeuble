 ...
 * @param {String} class Name of CSS class name
 */
jvm.SVGElement.prototype.addClass = function( class ){
 ...
 * @param {String} class Name of CSS class name
 */
jvm.VMLElement.prototype.addClass = function( class ){
  jvm.$(this.node).addClass(class);
};
